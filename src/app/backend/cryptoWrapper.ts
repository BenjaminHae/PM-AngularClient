...
export class EncryptionWrapper {
    ...
    static persistCredentials(user, secretkey, confkey, salt) {
        CookieHandler.setCookie("username", user);
    ...
    storePIN(device, pinSalt, pin) {
        ...
        return self.getPwdStore()
            ...
            .then(function(_confkey) {
                ...
                CookieHandler.setCookie('device', device);
            });
    }
    ...
    deletePIN() {
        ...
        CookieHandler.deleteCookie('device');
